...
CMD="'$PY' -u scripts/run_live_inventory_drizzle_lab.py --duration-sec '$DURATION' --interval-sec '$INTERVAL' --database '$DB' --start-usd '$START' --inventory-usd '$ACTIVE' --rebalance-usd '$SLICE' --cost-bps-side '$COST' --symbols $SYMBOLS"
