                    ...
                    try:
                        if self.governance:
                            ...
                            try:
                                ...
                                # Silently ignore ticker fetch errors - spread data is optional for governance
                                pass
                            try:
                                ...
                                # Silently ignore health snapshot errors - these metrics are optional for governance
                                pass
                            perf_metrics = {}
                            try:
                                if self.agents.get("logging"):
