...
def freeze_forecast_pair(*,data_store:Any,builder:ShadowIntentBuilder,freeze:Any,
 ...
 if ff.get("abstain") or af.get("abstain"):raise ValueError("paired_shadow_requires_two_non_abstain_forecasts")
 ...
 full_intent=builder.build(ff,full_observation,freeze).to_dict()
 blind_intent=builder.build(af,ablated_observation,freeze).to_dict()
