...
class SecurityAgent:
    ...
    def __init__(self, coordinator: Optional[Any] = None, key_file: str = "~/.config/hivenance/encryption.key"):
        self.coordinator = coordinator
        self.key_file = os.path.abspath(os.path.expanduser(key_file))
    ...
    def _load_or_generate_key(self) -> Fernet:
        ...
        if os.path.exists(self.key_file):
            ...
            parent = os.path.dirname(self.key_file)
