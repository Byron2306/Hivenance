...
class Config:
    ...
    phase1_observation_discovery_pool_multiplier: int
    phase1_observation_discovery_min_quote_volume_usd: float
    phase1_observation_discovery_max_abs_pct_move: float
    phase1_observation_near_eligible_quota: int
    phase1_observation_niche_quota: int
    phase1_observation_niche_max_volume_usd: float
    ...
    phase2_rapid_paper_notional_usd: float
    phase2_rapid_paper_max_open_trades: int
    phase2_rapid_paper_max_forecast_age_sec: int
    phase2_rapid_paper_max_observation_age_sec: int
    phase2_rapid_paper_data_gap_cooldown_sec: int
    phase2_rapid_paper_loss_cooldown_sec: int
    phase2_rapid_paper_negative_memory_max_hits: int
    phase2_rapid_paper_model_direction_gate_min_samples: int
    phase2_rapid_paper_model_direction_min_win_rate: float
    phase2_rapid_paper_model_direction_min_mean_net_bps: float
    phase2_rapid_paper_champion_scout_enabled: bool
    phase2_rapid_paper_champion_scout_min_samples: int
    phase2_rapid_paper_champion_scout_min_win_rate: float
    phase2_rapid_paper_champion_scout_min_mean_net_bps: float
    phase2_rapid_paper_champion_scout_min_total_net_bps: float
    phase2_rapid_paper_champion_scout_fetch_multiplier: int
    phase2_rapid_paper_champion_scout_history_limit: int
    phase2_rapid_paper_min_expected_net_bps: float
    phase2_rapid_paper_min_probability: float
    phase2_rapid_paper_allowed_directions: List[str]
    phase2_rapid_paper_ollama_url: str
    phase2_rapid_paper_ollama_model: str
...
def load_config() -> Config:
    ...
    return Config(
        ...
        # NOTE (2026-08-06): these discovery/niche keys previously existed only in
        # settings.yaml/observation_swarm.py's getattr() defaults but were never wired
        # here, so editing them in YAML had ZERO effect - always silently fell back to
        # hardcoded code defaults. Wired now so the niche-pair discovery reservation
        # (phase1_observation_niche_quota/niche_max_volume_usd) actually works.
        phase1_observation_discovery_pool_multiplier=settings.get("phase1_observation_discovery_pool_multiplier", 3),
        phase1_observation_discovery_min_quote_volume_usd=settings.get("phase1_observation_discovery_min_quote_volume_usd", 7500000.0),
        phase1_observation_discovery_max_abs_pct_move=settings.get("phase1_observation_discovery_max_abs_pct_move", 14.0),
        phase1_observation_near_eligible_quota=settings.get("phase1_observation_near_eligible_quota", 3),
        phase1_observation_niche_quota=settings.get("phase1_observation_niche_quota", 6),
        phase1_observation_niche_max_volume_usd=settings.get("phase1_observation_niche_max_volume_usd", 2000000.0),
        ...
        phase2_rapid_paper_notional_usd=settings.get("phase2_rapid_paper_notional_usd", 5.0),
        phase2_rapid_paper_max_open_trades=settings.get("phase2_rapid_paper_max_open_trades", 12),
        phase2_rapid_paper_max_forecast_age_sec=settings.get("phase2_rapid_paper_max_forecast_age_sec", 180),
        phase2_rapid_paper_max_observation_age_sec=settings.get("phase2_rapid_paper_max_observation_age_sec", 300),
        phase2_rapid_paper_data_gap_cooldown_sec=settings.get("phase2_rapid_paper_data_gap_cooldown_sec", 3600),
        phase2_rapid_paper_loss_cooldown_sec=settings.get("phase2_rapid_paper_loss_cooldown_sec", 3600),
        phase2_rapid_paper_negative_memory_max_hits=settings.get("phase2_rapid_paper_negative_memory_max_hits", 2),
        phase2_rapid_paper_model_direction_gate_min_samples=settings.get("phase2_rapid_paper_model_direction_gate_min_samples", 5),
        phase2_rapid_paper_model_direction_min_win_rate=settings.get("phase2_rapid_paper_model_direction_min_win_rate", 0.35),
        phase2_rapid_paper_model_direction_min_mean_net_bps=settings.get("phase2_rapid_paper_model_direction_min_mean_net_bps", 0.0),
        phase2_rapid_paper_champion_scout_enabled=settings.get("phase2_rapid_paper_champion_scout_enabled", False),
        phase2_rapid_paper_champion_scout_min_samples=settings.get("phase2_rapid_paper_champion_scout_min_samples", 3),
        phase2_rapid_paper_champion_scout_min_win_rate=settings.get("phase2_rapid_paper_champion_scout_min_win_rate", 0.50),
        phase2_rapid_paper_champion_scout_min_mean_net_bps=settings.get("phase2_rapid_paper_champion_scout_min_mean_net_bps", 5.0),
        phase2_rapid_paper_champion_scout_min_total_net_bps=settings.get("phase2_rapid_paper_champion_scout_min_total_net_bps", 1.0),
        phase2_rapid_paper_champion_scout_fetch_multiplier=settings.get("phase2_rapid_paper_champion_scout_fetch_multiplier", 8),
        phase2_rapid_paper_champion_scout_history_limit=settings.get("phase2_rapid_paper_champion_scout_history_limit", 10000),
        phase2_rapid_paper_min_expected_net_bps=settings.get("phase2_rapid_paper_min_expected_net_bps", 0.0),
        phase2_rapid_paper_min_probability=settings.get("phase2_rapid_paper_min_probability", 0.50),
        phase2_rapid_paper_allowed_directions=settings.get("phase2_rapid_paper_allowed_directions", ["UP"]),
        phase2_rapid_paper_ollama_url=settings.get("phase2_rapid_paper_ollama_url", "http://127.0.0.1:11434"),
        phase2_rapid_paper_ollama_model=settings.get("phase2_rapid_paper_ollama_model", "beast-crystal-qwen25-05b:latest"),
        ...
        encryption_key_file=settings.get("encryption_key_file", "~/.config/hivenance/encryption.key"),
