                    ...
                    try:
                        if self.governance:
                            ...
                            try:
                                ...
                                # Silently ignore ticker fetch errors - spread data is optional for governance decisions
                                pass
                            try:
                                ...
                                # Silently ignore health snapshot errors - execution quality metrics are optional
                                pass
                            perf_metrics = {}
                            try:
                                if self.agents.get("logging"):
