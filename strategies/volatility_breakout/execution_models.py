...
class CostAttribution:
    ...
    net_bps: float
    gross_signal_bps: float = 0.0
    entry_fee_bps: float = 0.0
    exit_fee_bps: float = 0.0
    maker_fee_bps: float = 0.0
    taker_fee_bps: float = 0.0
    failed_fill_cost_bps: float = 0.0
    chase_cost_bps: float = 0.0
    cost_schema_version: str = "phase3.cost_attribution.v2"
    fee_source: str = "configured_research_profile"
