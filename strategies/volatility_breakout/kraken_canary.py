...
class KrakenRestClient:
    ...
    def trade_volume(self, pair: Optional[str] = None) -> dict[str, Any]:
        payload: dict[str, Any] = {"fee-info": "true", "fee_schedule": "true"}
        if pair:
            payload["pair"] = pair
        return self.private("/0/private/TradeVolume", payload)
