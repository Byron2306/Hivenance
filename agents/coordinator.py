                    ...
                    try:
                        if self.governance:
                            ...
                            try:
                                ...
                                # Silently ignore ticker fetch failures - spread_pct is optional for decision quality
                                pass
                            try:
                                ...
                                # Silently ignore health snapshot failures - these metrics are optional for decision quality
                                pass
                            perf_metrics = {}
                            try:
                                if self.agents.get("logging"):
